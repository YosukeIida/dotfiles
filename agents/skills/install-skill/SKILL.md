...
2. If the file is in `~/Downloads/`, warn the user that macOS may block terminal access and ask them to move it to `~/Desktop/` or `~/workspace/` first
3. Create the destination directory: `<target>/<skill-name>/`
